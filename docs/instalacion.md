...
Cómo levantar el proyecto en tu máquina. Si buscás una explicación de qué hace el sitio, ver el
[`README.md`](../README.md) de la raíz; si ya tenés el entorno andando y buscás notas más
puntuales (Docker, Prisma, email, credenciales de bootstrap), ver
[`docs/local-dev-notes.md`](./local-dev-notes.md).
